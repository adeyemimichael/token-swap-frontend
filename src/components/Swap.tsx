...
export const Swap: React.FC = () => {
    const TOKEN_ADDRESSES = {
     SDT:  '0xdaf4d32266b6400826ff253a4ce077aeef97d0bb',
     SKT: '0x45f4027b38ca734b762598f33b9146d337228359',
    };
   
    const TOKENSWAP_CONTRACT_ADDRESS = '0x7ac5ff10d8c46f97131a212881a8817a9ee8394a'
  ;
